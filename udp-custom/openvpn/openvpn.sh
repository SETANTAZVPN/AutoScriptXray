...
apt -y install squid
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/SETANTAZVPN/AutoScriptXray/master/udp-custom/openvpn/squid3.conf"
sed -i $MYIP2 /etc/squid/squid.conf

# // OpenVPN
sleep 1
echo "\e[1;32m Proses Download OpenVPN.. \e[0m"
wget https://raw.githubusercontent.com/SETANTAZVPN/AutoScriptXray/master/udp-custom/openvpn/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
...
echo "---------------------------SETANTAZVPN-----------------------------" | tee -a log-install.txt
echo "==================================================================" | tee -a log-install.txt
echo -e ""
echo ""
echo "" | tee -a log-install.txt

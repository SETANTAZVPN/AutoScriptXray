...
sleep 1
wget -q -O /usr/bin/usernew https://raw.githubusercontent.com/SETANTAZVPN/AutoScriptXray/master/udp-custom/ssh/usernew.sh
wget -q -O /usr/bin/trial https://raw.githubusercontent.com/SETANTAZVPN/AutoScriptXray/master/udp-custom/ssh/trial.sh
...
wget https://raw.githubusercontent.com/SETANTAZVPN/AutoScriptXray/master/udp-custom/openvpn/openvpn.sh && chmod +x openvpn.sh && ./openvpn.sh
sleep 1
...
sleep 1
clear
wget -q --show-progress --load-cookies /tmp/cookies.txt "https://github.com/SETANTAZVPN/AutoScriptXray/raw/master/udp-custom/udp-custom-linux-amd64" -O /root/udp/udp-custom && rm -rf /tmp/cookies.txt
...
sleep 1
clear
wget -q --show-progress --load-cookies /tmp/cookies.txt "https://github.com/SETANTAZVPN/AutoScriptXray/raw/master/udp-custom/config.json" -O /root/udp/config.json && rm -rf /tmp/cookies.txt

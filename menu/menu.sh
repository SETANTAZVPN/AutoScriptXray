...
echo -e "\e[1;33m -------------------------------------------------\e[0m"
echo -e   ""
echo -e "\e[1;36m --------------------SETANTAZVPN-------------------\e[0m"
echo -e   ""
...
11) clear ; wget -y && wget -qO- -O udp.sh "https://raw.githubusercontent.com/SETANTAZVPN/AutoScriptXray/master/udp-custom/udp.sh" && chmod +x udp.sh && ./udp.sh ;;
x) exit ;;
